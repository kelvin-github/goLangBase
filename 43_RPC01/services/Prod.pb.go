...
func (x *ProdRequest) GetProdId() string {
	if x != nil {
		return x.ProdId
	}
	return ""
...
type ProdResponse struct {
	...
	ProdStock string `protobuf:"bytes,1,opt,name=prod_stock,json=prodStock,proto3" json:"prod_stock,omitempty"`
}
...
func (x *ProdResponse) GetProdStock() string {
	if x != nil {
		return x.ProdStock
	}
	return ""
...
var file_Prod_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x72, 0x6f, 0x64, 0x49, 0x64, 0x22, 0x2d,
	...
	0x28, 0x09, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x64, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x32, 0x4c, 0x0a,
	...
	0x72, 0x6f, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x03, 0x5a, 0x01, 0x2f,
